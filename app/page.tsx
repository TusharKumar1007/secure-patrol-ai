  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-900 p-4">
      <div className="bg-white p-8 rounded-xl shadow-2xl w-full max-w-md">
        <h1 className="text-3xl font-bold text-center mb-2 text-slate-800">Secure Patrol</h1>
        <p className="text-center text-slate-500 mb-8">Login to access the system</p>
